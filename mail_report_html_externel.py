...
from report_externel import report_externel
...
table_name = ["cig_dw.ods_bitauto_website_d_pc", "cig_dw.ods_bitauto_website_d_mobile",
              ...
              "mobile_dw.stage_mobile_bjdq_d","mobile_dw.stage_mobile_yiche_d",
...
# ('|                  库.表                  |   昨天入库值     |      平均值      | 状态 |')
# ('+-----------------------------------------+------------------+------------------+------+')
print report_externel(searchList=[
    {'title': "数据仓库接入报告(" + Day1ago + ")", 'title_week': "最近一周", 'title_month': "最近一个月", 'database': "库.表",
